...
public class PostFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (userType.equals("Worker")){
            ...
            String jobType = PreferenceManager.getDefaultSharedPreferences(getActivity()).getString("jobType","");

            FirebaseDatabase.getInstance().getReference().child("request").orderByChild("jobType").equalTo(jobType).addValueEventListener(new ValueEventListener() {
                @Override
